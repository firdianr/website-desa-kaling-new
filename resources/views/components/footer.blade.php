<footer class="bg-gray-300 h-16 bottom-0 rounded-sm shadow sm:flex sm:items-center sm:justify-between px-4 py-8 sm:p-1 xl:p-1 xl:px-8 dark:bg-gray-800 antialiased">
    <p class="mb-4 text-sm text-center text-gray-500 dark:text-gray-400 sm:mb-0">
        &copy; 2024 - KKN Tim II Undip Tahun 2024
    </p>
    <div class="flex justify-center items-center space-x-1">
      ...
      <a href="https://www.instagram.com/lifeatkaling?igsh=MWYwMXdoanh4d2Jxeg==" target="_blank" data-tooltip-target="tooltip-dribbble" class="inline-flex justify-center p-2 text-gray-500 rounded-lg cursor-pointer dark:text-gray-400 dark:hover:text-white hover:text-gray-900 hover:bg-gray-100 dark:hover:bg-gray-600">
