<x-dashboard-layout>
    ...
    <div class="py-2 px-4 ml-auto mr-4 max-w-screen-xl lg:py-2 lg:px-0">
        <a href="/dashboard/hukums/create" type="button" class="pl-2 pr-3 py-2.5 text-sm font-medium text-white inline-flex items-center bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-lg text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        <tbody>
                            ...
                            <tr class="border-b-4 border-gray-600  dark:border-gray-700 hover:bg-gray-200">
                                ...
                                <td class="px-4 py-8 flex items-center justify-end space-x-1">
