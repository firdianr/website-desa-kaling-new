<x-dashboard-layout>
    ...
    <div class="py-2 px-4 mx-auto max-w-screen-xl lg:py-2 lg:px-2">
      ...
      @if (session()->has('success'))
        ...
        <h1 class="text-xl font-bold">Kelola Profil Dusun</h1>

    </div>

    <div class="py-2 px-4 ml-auto mr-4 max-w-screen-xl lg:py-2 lg:px-0">
      <a href="/dashboard/dusuns/create" type="button" class="pl-2 pr-3 py-2.5 text-sm font-medium text-white inline-flex items-center bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-lg text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                ...
                <tbody>
                    ...
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <td class="px-6 py-4 space-x-3 flex items-center">
                            <a href="/dashboard/dusuns/{{ $dusun->slug }}/edit" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Edit</a>

                            @php
                                $hasPosts = $dusun->posts()->count() > 0;
                            @endphp

                            <form action="/dashboard/dusuns/{{ $dusun->slug }}" method="POST" class="inline-block ml-3">
                                @method('delete')
                                @csrf
                                <button onclick="return confirm('Yakin Hapus Dusun?')" 
