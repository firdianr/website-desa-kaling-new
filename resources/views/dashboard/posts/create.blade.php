<x-dashboard-layout>
    ...
    <p class="mb-8 ml-12">Halaman ini digunakan untuk membuat sebuah berita yang akan ditampilkan pada halaman Portal Berita</p>
    ...
    <form method="POST" action="/dashboard/posts" enctype="multipart/form-data">
        ...
        <div class="space-y-6 mr-4 mb-10 ml-12">
            ...
            <div>
                ...
                <input type="text" id="slug" name="slug" value="{{ old('slug') }}" readonly required class="@error('slug') is-invalid @enderror bg-gray-50 border border-gray-300 text-gray-900 text-lg rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                @error('slug')
                    <p id="helper-text-explanation" class="mt-2 text-sm text-red-600">
                        {{ $message }}
                    </p>
            ...
            <div>
                ...
                <div class="flex flex-col sm:flex-row items-center justify-center w-full space-x-4 space-y-4">
                    ...
                    <div id="preview-container" class="w-full sm:w-1/2 mb-4 sm:mb-0"></div>
                </div>
                @error('image')
                    <p id="helper-text-explanation" class="mt-2 text-sm text-red-600">
                        {{ $message }}
            ...
            <div>
                ...
                <input type="text" id="image_description" name="image_description" autocomplete="off" value="{{ old('image_description') }}" required class="@error('image_description') is-invalid @enderror bg-gray-50 border border-gray-300 text-gray-900 text-lg rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
